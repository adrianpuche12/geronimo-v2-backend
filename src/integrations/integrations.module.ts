...
import { GmailSyncProcessor } from './queue/processors/gmail-sync.processor';
...
@Module({
  ...
  providers: [
    ...
    GetIntegrationStatsUseCase,
    GetSyncLogsUseCase,
    GetIntegrationItemsUseCase,
